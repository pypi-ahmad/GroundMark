...
layers_spec = [
    {
        ...
        "name": "User Interface & Visualization",
        "description": "Interactive Streamlit web frontend, clipboard integrations, launcher scripts, and interactive architecture visualization diagrams.",
        "patterns": [
            "file:src/ui/app.py",
    ...
    },
    {
        ...
        "description": "Core computer vision and document layout algorithms handling PDF rasterization, image deskewing, reading order, table extraction, and markdown serialization.",
        "patterns": [
            "file:src/layout.py",
    ...
    },
    {
        ...
        "description": "Environment settings, dependencies specifications, architecture configs, and analysis manifests.",
        "patterns": [
            "config:.env.example",
            ...
            "config:.ua/intermediate/batches.json",
            "config:.ua/intermediate/scan-result.json",
            "config:.ua/tmp/ua-import-map-input.json",
            "config:.ua/tmp/ua-import-map-output.json",
            "config:.ua/tmp/ua-scan-files.json"
        ]
    }
]
...
if unassigned:
    ...
    print("SUCCESS: All 70 file nodes cleanly partitioned into 9 layers!")
