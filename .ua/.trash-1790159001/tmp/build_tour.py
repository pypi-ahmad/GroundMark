...
tour = [
    ...
    {
        "order": 4,
        "title": "Markdown Serialization & Export Utilities",
        "description": "See how structured bounding boxes and cell coordinates are reconstituted into clean GitHub Flavored Markdown, HTML tables, and exported artifacts.",
        "nodeIds": [
    ...
    {
        "order": 9,
        "title": "CLI & Interactive Web UI",
        "description": "Tour the CLI entry point and Streamlit frontend that provide command-line batch parsing, document inspection, bounding box debugging overlays, and real-time chat.",
        "nodeIds": [
            "file:src/cli.py",
            "file:src/ui/app.py",
            "file:run.cmd"
    ...
    },
    {
        ...
        "description": "Review the evaluation harnesses and automated test suite benchmarking layout IoU, prompt variations, resolution latency trade-offs, and CLI extraction.",
        "nodeIds": [
